...
1. De vorm van het register (lid 3)
...
1. Overige registratieverplichtingen uit de AVG
   - 7.1 
   - 13.1
   - 13.2
   - 14f
...
- **Voor welk doeleinde verricht u deze verwerking?**
  ...
  - <!-- Het doeleinde dient specifieker te worden omschreven. Wat zijn de diensten van Bikr? Waarom zijn voor de levering de persoonsgegevens nodig? -->
- **Welke categorieën persoonsgegevens verwerkt u?**
  - NAW-gegevens
  - Financiële bijzonderheden
  - Persoonlijke kenmerken
  - Lidmaatschap van een vakvereniging
  - <!-- Waar komen de categorieen vandaan en houdt de verantwoordelijke zelf de inhoud van ze bij? -->
...
| Categorieën persoonsgegevens       | Verwerkingsgrond                         |
| ---------------------------------- | ---------------------------------------- |
| Lidmaatschap van een vakvereniging | Uitdrukkelijke toestemming <!-- Lastig, oke ☺ . Is dit anders dan Ondubbelzinnige toestemming?--> |
...
- **Gedurende welke termijn bewaart u deze persoonsgegevens?**
  - De gegevens worden tot twee jaar na afloop van het abonnement bewaard. Dit onder meer ten behoeve van betalingsachterstanden. <!-- Valt dit nog binnen de doeleinden, of dient een of beide onderdelen uitgebreid te worden? -->
- **Welke technische en organisatorische beveiligingsmaatregelen heeft u getroffen?**
  - Technisch / Organisatorisch
    - De gegevens worden versleuteld opgeslagen.
      ...
      - <!--Voor nu zijn bovenstaande punten (lid 3) nog niet te implementeren. We dienen wellicht voorbeelden te geven van onderwerpen die lading van 32(1) dekken. -->
...
| Categorieën persoonsgegevens       | Verwerkingsgrond                         |
| ---------------------------------- | ---------------------------------------- |
| Gegevens betreffende de gezondheid | Noodzakelijk voor doeleinden van arbeidsgeneeskunde <!--Mooi gevonden; voert Bikr arbeidsgeneeskunde uit? In de praktijk heeft werkgever vaak geen grond om medische gegevens te verwerken. Arbodienst (of -arts) wellicht wel. --> |
...
| Categorieën persoonsgegevens | Verwerkingsgrond                         |
| ---------------------------- | ---------------------------------------- |
| NAW-gegevens                 | Toestemming <!-- Toestemming in (toekomstige) arbeidsrelatie in beginsel niet mogelijk. Andere grond mogelijk? --> |
