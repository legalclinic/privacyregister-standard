...
- art. 39
  ...
  <!--Mee eens. Al volgen een deel van deze verplichtingen automatisch uit het voldoen aan de registerplicht. Daarnaast kunnen we niet aan de wensen van elke gebruiker geheel voldoen.  -->
...
<!--Mee eens. Te bespreken of hiervoor een werkwijze aanraden. -->
...
<!--*publieke transparantie is juist wel het doel van dit project.*-->

<!--Afhankelijk van hoe we het blockchain-aspect inzetten. Voor mij in eerste instantie geen prioriteit om publieke transparantie te implementeren. -->
...
<!--Wat verwerken is, is aan de verantwoordelijke en hoe hij de verwerking beschrijft. Waar verwacht je dat wij een keuze maken voor de interpretatie van 'verwerken'? -->
...
<!-- Als we doeleinden aanraden, dan dienen we duidelijk te maken dat deze gedetailleerder moeten worden gemaakt door de gebruiker. Mijn voorkeur heeft om dit helemaal aan de gebruiker te laten. -->
...
<!--Is onze technische uitwerking juist niet wat het eindproduct dynamisch zou moeten maken, namelijk een manier om het register te blijven tweaken? Continu updaten ligt dan bij de verantwoordelijke. -->
...
<!--*rol - of functieomschrijving moet mogelijk zijn in ons register.*-->
...
<!--Of bedoelen ze een simpele "nee, we geven geen gegevens door"? Een blanco-veld is namelijk ambigu. -->

SA ontvangers in het verleden als in de toekomst moeten worden genoemd in het register

<!--*blockchain*-->

<!--Afhankelijk van wat we op blockchain opslaan. Mijn voorkeur is zo minimaal mogelijk; alleen een hash of in combinatie met verantwoordelijke/verwerker. -->
...
<!--*Beschreven bepalingen zijn te specifiek voor ons privacy register. adequaatheidsbesluiten idzv art. 45 lid 1 moeten we overwegen*--> 

<!--Is aan de verantwoordelijke. Te intensief voor ons om bij te houden welke landen adequaat zijn en welke niet (plus bijhouden mogelijke overige oplossingen zoals Privacy Shield) -->
...
<!--*enkel verwijzen in ons register? uploaden van bestanden mogelijk maken?*-->

<!--Uploaden lijkt me onwenselijk. Verwijzen naar interne docs is aan verantwoordelijke zelf. -->
...
<!--Goed punt. Onze keuze. Willen we eerst NED of direct ENG versie maken?-->
